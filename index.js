...
addEventListener('fetch', async event => {
  ...
  if (path.match('/bulk[0-3]')) event.respondWith(bulkRedirects(request, REDIRECT_MAP))
  if (path.includes('/send')) event.respondWith(redirectResponse(somepathToRedirectTo))
